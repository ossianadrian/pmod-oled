...
HD_PWD='C:/Storage/facultate/SSC/Project Pmod OLED/Nexys4OLEDdemo/Nexys4OLEDdemo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodOLED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodOLED.tcl
