...
HD_PWD='C:/Storage/facultate/SSC/Project Pmod OLED/Nexys4OLEDdemo/Nexys4OLEDdemo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodOLED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodOLED.tcl -notrace
